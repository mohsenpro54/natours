...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      type: Number,
      validate: {
        // THIS, NOLY POINTS TO CURRENT DOC ON NEW DOCUMENT CREATION
        validator: function (val) {
          return val < this.price; // 100 < 200
        },
        message: 'discount price ({VALUE}) should be bellow regulare price',
      },
    },
    summary: {
      type: String,
...
/////////DOCUMENT MIDELWARE : run befors .save() and create() 'just save and create!
