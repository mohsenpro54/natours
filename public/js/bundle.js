...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oc2VuNTQiLCJhIjoiY2t0cHE4MWFlMGY3bTJ1bDM4dzE2dWttaSJ9.-tlXCY3Xbz5NNA9_O1pplg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mohsen54/cktpsq7sj2jcl19ndknhgblk9',
    scrollZoom: false // center: [-118.440617, 34.047475],
    // zoom: 10,
    // interactive: false,
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', _context.t0.responce.data.message);
...
var stripe = Stripe('pk_test_51JdWuMHcDosX9q2Y79gR9OsX03aqFiDSoKUevbG190UkRABMEAIY6s3t5d8OQQIoSPov6PEk5jr8DCxyb0llGY8z00HcjEwEH2');
...
if (mapBox) {
  var locations = JSON.parse(document.mapBox.dataset.locations);
